...
var (
	...
	predefinedLayouts = []struct {
		...
		{chrono.ISO8601DateTimeSimple, "08070209T010502Z", chrono.OffsetDateTimeOf(formatYear, formatMonth, formatDay, formatHour, formatMin, formatSec, 0, formatOffsetHours, formatOffsetMins)},
		{chrono.ISO8601DateTimeExtended, "0807-02-09T01:05:02Z", chrono.OffsetDateTimeOf(formatYear, formatMonth, formatDay, formatHour, formatMin, formatSec, 0, formatOffsetHours, formatOffsetMins)},
